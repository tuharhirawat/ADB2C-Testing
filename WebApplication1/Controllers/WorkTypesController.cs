...
namespace WebApplication1.Controllers
{
    public class WorkTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WorkTypeId,TypeName,CommercialOrNot,Discount")] WorkType workType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkTypeId,TypeName,CommercialOrNot,Discount")] WorkType workType)
        {
